...
| assetsPath          | `string`  | /                                     | If you are using a framework, the public files are most likely to be stored in a subfolder. Change this value to the subfolder where the files are located, this way all the final urls will include this path. Example: `themes/custom/theme_name/` (Notice the trailing slash!) |
