...
| forceNoHashesOnDev                | `boolean`       | false               | Force to not add contenthash to bundle files when developing (yarn start || yarn watch). (Useful when HTML is not managed by Webpack)                                                                                                     |
